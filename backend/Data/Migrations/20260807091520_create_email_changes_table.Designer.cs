...
namespace BoostingHub.backend.Data.Migrations
{
    ...
    [Migration("20260807091520_create_email_changes_table")]
    partial class create_email_changes_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoostingHub.backend.Models.ActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BoostingHub.backend.Models.EmailChange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("email_changes", (string)null);
                });

            modelBuilder.Entity("BoostingHub.backend.Models.ManualPaymentProof", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("PaidVoucher")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("paid_voucher");
                    ...
                    b.ToTable("manual_payment_proofs", (string)null);
                });
            ...
            modelBuilder.Entity("BoostingHub.backend.Models.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BoostingHub.backend.Models.SocialMediaAccount", b =>
                {
                    ...
                    b.ToTable("social_media_accounts");
                });
            ...
            modelBuilder.Entity("BoostingHub.backend.Models.TaskComplete", b =>
                {
                    ...
                    b.ToTable("task_complete", (string)null);
                });
